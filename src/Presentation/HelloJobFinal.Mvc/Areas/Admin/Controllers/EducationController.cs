...
namespace HelloJobFinal.Mvc.Areas.Admin.Controllers
{
    ...
    public class EducationController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateEducationVm create)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateEducationVm update)
        {
        ...
        {
            GetEducationVm get = await _service.GetByIdAsync(id);
