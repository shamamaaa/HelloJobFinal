...
namespace HelloJobFinal.Mvc.Areas.Admin.Controllers
{
    ...
    public class WorkingHourController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateWorkingHourVm create)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateWorkingHourVm update)
        {
        ...
        {
            GetWorkingHourVm get = await _service.GetByIdAsync(id);
