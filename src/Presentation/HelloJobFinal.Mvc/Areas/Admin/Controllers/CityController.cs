...
namespace HelloJobFinal.Mvc.Areas.Admin.Controllers
{
    ...
    public class CityController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateCityVm create)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateCityVm update)
        {
        ...
        {
            GetCityVm get = await _service.GetByIdAsync(id);
