...
namespace HelloJobFinal.Mvc.Areas.Admin.Controllers
{
    ...
    public class ExperienceController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateExperienceVm create)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateExperienceVm update)
        {
        ...
        {
            GetExperienceVm get = await _service.GetByIdAsync(id);
